  ...
  return (
    <div className='home_body custon_container'>
        ...
        <div className='second_part'>
          ...
          <div className='second_part_txt'>
            <article>
              ...
              <p>Məhsullarımız, tam gigiyenik şəraitdə və innovativ texnologiyalar vasitələr ilə istehsal olunur. Mehriban və peşəkar komanda ilə Avromak MMC qoyduğu hədəflərə çatmaqdadır. Məhsullarımız AZS 731-2012 “Halal Qida” sertifkatına layiq görülmüşdür.</p>
            </article>
            <Link to='/' ><p>KEYFİYYƏT RƏMZİMİZDİR</p> <img src={up_arch} /> </Link>
          </div>
      ...
      <article className='brendler'>
        <p>BRENDLƏR</p>
        <p>“Avromak” MMC-nin əsas məqsədi istehsal və distribüterlik etdiyi <br/> məhsulların çeşidlərinin və keyfiyyətinin optimallaşdırılmasıdır.</p>
      </article>
